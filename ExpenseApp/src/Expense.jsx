...
const Expense = () => {
  ...
  const fetchExpenses = async (page, token) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/expenses`,
        {
          params: { page, limit: 5 }, 
          headers: {
      ...
      setExpenselist(Array.isArray(data.response) ? data.response : []);
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-end align-items-center">
                  <button
                    ...
                    onClick={() => {
                      setupdateAmount(selectExpense.amount)
